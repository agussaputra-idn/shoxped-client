...
const defaultActive = 'h-3 w-3 fill-yellow-300 text-yellow-300';
const defaultNonActive = 'h-3 w-3 fill-current text-gray-300';

const ProductRating = ({ rating, activeClassname = defaultActive, nonActiveClassname = defaultNonActive }: Props) => {
